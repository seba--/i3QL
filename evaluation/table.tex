...
& \multicolumn{1}{ c }{\bf NO-OPT} & \multicolumn{2}{ c }{\bf PE-OPT}  & \multicolumn{2}{ c }{\bf ALG-PE-OPT}\\
\toprule
\multicolumn{1}{r|}{} & Time & Time & Speedup & Time & Speedup \\
\midrule
\multicolumn{1}{r|}{A} & 1329.936 & 345.684 & 3.85 & 2.312 & 575.22 \\
\multicolumn{1}{r|}{B} & 2.084 & 2.180 & 0.96 & 2.162 & 0.96 \\
\multicolumn{1}{r|}{C} & 10.889 & 12.873 & 0.85 & 2.299 & 4.74 \\
\multicolumn{1}{r|}{D} & 39.452 & 47.218 & 0.84 & 2.254 & 17.50 \\
\multicolumn{1}{r|}{E} & 4.842 & 2.806 & 1.73 & 2.491 & 1.94 \\
\multicolumn{1}{r|}{F} & 2.464 & 2.436 & 1.01 & 2.152 & 1.15 \\
\multicolumn{1}{r|}{G} & 2.345 & 2.248 & 1.04 & 2.083 & 1.13 \\
\multicolumn{1}{r|}{H} & 2.257 & 2.259 & 1.00 & 2.121 & 1.06 \\
\multicolumn{1}{r|}{I} & 2.198 & 2.213 & 0.99 & 2.096 & 1.05 \\
\multicolumn{1}{r|}{J} & 2.109 & 2.151 & 0.98 & 2.055 & 1.03 \\
\multicolumn{1}{r|}{K} & 3.244 & 3.019 & 1.07 & 2.345 & 1.38 \\
\multicolumn{1}{r|}{L} & 2.264 & 2.242 & 1.01 & 2.100 & 1.08 \\
\multicolumn{1}{r|}{M} & 2.185 & 2.241 & 0.98 & 2.109 & 1.04 \\
\multicolumn{1}{r|}{N} & 3.785 & 2.425 & 1.56 & 2.317 & 1.63 \\
\multicolumn{1}{r|}{O} & 2.532 & 2.238 & 1.13 & 2.140 & 1.18 \\
\bottomrule
\end{tabular}
\end{center}
...
\caption{Duration in seconds, speed up relative to NO-OPT.}

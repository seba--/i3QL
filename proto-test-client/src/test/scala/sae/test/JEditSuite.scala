...
class JEditSuite {
  ...
  def fanOut: Unit = {
    ...
    val res2: QueryResult[Some[Int]] = γ(σ((x: (ReferenceType, Type)) => x._2 == ObjectType("org.gjt.sp.jedit.bsh.SimpleNode"))(fanOutSet), Count[(ReferenceType, Type)]())
    val res3: QueryResult[Some[Int]] = γ(σ((x: (ReferenceType, Type)) => x._2 == ObjectType("org.gjt.sp.jedit.Buffer"))(fanOutSet), Count[(ReferenceType, Type)]())
    val res4: QueryResult[Some[Int]] = γ(σ((x: (ReferenceType, Type)) => x._2 == ObjectType("org.gjt.sp.jedit.ActionSet"))(fanOutSet), Count[(ReferenceType, Type)]())

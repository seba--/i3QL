...
object queens3O1TC {
	...
	def apply(a1 : Term, a2:Term, a3:Term) : Solutions = {
		new queens3O1TCp(a1,a2,a3)
	}
}

class queens3O1TCp (private val a1 : Term,private val a2 : Term, val a3:Term) extends MultipleRules { 
	...
	*/
	...
	private class queens3O1TCc1 extends Solutions {
	...
	private class queens3O1TCc2 extends MultipleGoals {
		...
		def goal(i : Int ) : Solutions = i match {
			...
			case 3 => queens3O1TC(UnplacedQs1,new ListElement2(Q,a2),a3)
		}	
	}

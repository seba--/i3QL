...
object HibernateEnsembles {
    ...
    object Hibernate_1_0 extends IArchitectureModel {
        ...
        val Actions = Ensemble("Actions", "class_with_members('cirrus.hibernate.impl','RelationalDatabaseSession$Executable') \nor class_with_members('cirrus.hibernate.impl','ScheduledDeletion') \nor class_with_members('cirrus.hibernate.impl','ScheduledCollectionDeletes') \nor class_with_members('cirrus.hibernate.impl','ScheduledCollectionUpdates') \nor class_with_members('cirrus.hibernate.impl','ScheduledCollectionInserts') \nor class_with_members('cirrus.hibernate.impl','ScheduledCollectionRecreate') \nor class_with_members('cirrus.hibernate.impl','ScheduledInsertion') \nor class_with_members('cirrus.hibernate.impl','ScheduledCollectionRemove') \nor class_with_members('cirrus.hibernate.impl','ScheduledUpdate')")
        val SessionManagement = Ensemble("SessionManagement", "class_with_members('cirrus.hibernate.impl','SessionFactoryObjectFactory') \nor class_with_members('cirrus.hibernate.impl','SessionImplementor') \nor class_with_members('cirrus.hibernate','SessionFactory') \nor class_with_members('cirrus.hibernate','Session') \nor class_with_members('cirrus.hibernate.impl','RelationalDatabaseSession') \nor class_with_members('cirrus.hibernate.impl','RelationalDatabaseSessionFactory')\nwithout ( \n\tclass_with_members('cirrus.hibernate.impl','RelationalDatabaseSession$Executable')  \n)")
        val PersistenceManager = Ensemble("PersistenceManager", "class_with_members('cirrus.hibernate.impl','ClassPersister') \nor class_with_members('cirrus.hibernate.type','PersistentObjectType') \nor class_with_members('cirrus.hibernate.type','PersistentEnumType') \nor class_with_members('cirrus.hibernate.impl','PersistenceImplementor')\nor package('cirrus.hibernate.collections')\nor class_with_members('cirrus.hibernate.impl','CollectionPersister') \nor class_with_members('cirrus.hibernate.type','PersistentCollectionType')\nor class_with_members('cirrus.hibernate.impl','PersisterCache')\nor class_with_members('cirrus.hibernate.impl','IdentifierIterator') \nor class_with_members('cirrus.hibernate.impl','ByIDQuery')")
        val Transactions = Ensemble("Transactions", "package('cirrus.hibernate.transaction') or class_with_members('cirrus.hibernate','Transaction')")
        ...
        val Proxies = Ensemble("Proxies", "class_with_members('cirrus.hibernate.impl','LazyInitializer') \nor class_with_members('cirrus.hibernate.impl','HibernateProxyHelper') \nor class_with_members('cirrus.hibernate.impl','HibernateProxy')")
        val SchemaTool = Ensemble("SchemaTool", "class_with_members('cirrus.hibernate.tools','SchemaExportGUI') \nor class_with_members('cirrus.hibernate.tools','SchemaExport')")
        ...
        val PropertySettings = Ensemble("PropertySettings", "class_with_members('cirrus.hibernate','Environment')")
        ...
        val DataTypes = Ensemble("DataTypes", "package('cirrus.hibernate.type')\nwithout\n(\n\tclass_with_members('cirrus.hibernate.type','PersistentObjectType') \n\tor class_with_members('cirrus.hibernate.type','PersistentEnumType') \n\tor class_with_members('cirrus.hibernate.type','PersistentCollectionType')\n\tor class_with_members('cirrus.hibernate.type','SerializationException')\n\n)\nor class_with_members('cirrus.hibernate','UserType')")
        val CodeGeneratorTool = Ensemble("CodeGeneratorTool", "package('cirrus.hibernate.tools.codegen') or class_with_members('cirrus.hibernate.tools','CodeGenerator') or class_with_members('cirrus.hibernate.tools','ProxyGenerator')")
        val MappingGeneratorTool = Ensemble("MappingGeneratorTool", "package('cirrus.hibernate.tools.reflect') or class_with_members('cirrus.hibernate.tools','MapReflectGUI') or class_with_members('cirrus.hibernate.tools','MapReflectGUI$1') or class_with_members('cirrus.hibernate.tools','MapGenerator')")
        ...
        val XMLDatabinder = Ensemble("XMLDatabinder", "class_with_members('cirrus.hibernate','Databinder') or class_with_members('cirrus.hibernate.xml','XMLDatabinder')")
        val UtilitiesAndExceptions = Ensemble("UtilitiesAndExceptions", "package('cirrus.hibernate.helpers') \nor class_with_members('cirrus.hibernate','HibernateException') \nor class_with_members(transitive(supertype(class('cirrus.hibernate','HibernateException')))) \nor class_with_members('cirrus.hibernate','AssertionFailure')\nor class_with_members('cirrus.hibernate','LazyInitializationException')")

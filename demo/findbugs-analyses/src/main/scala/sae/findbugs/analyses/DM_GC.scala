...
object DM_GC
{
    ...
    def unoptimized(database: Database): LazyView[Dependency[MethodDeclaration, MethodReference]] = {
    ...
    def optimized(database: Database): LazyView[Dependency[MethodDeclaration, MethodReference]] =

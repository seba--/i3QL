...
public class TermFactory {
    ...
    protected IntValue newAtom(long value) {
	return IntValue.IntegerAtom(value);
    }

    protected FloatValue newAtom(double value) {
	return FloatValue.instance(value);
    }

    protected StringAtom newAtom(String string) {
	...
	Term rest = StringAtom.EMPTY_LIST_FUNCTOR;

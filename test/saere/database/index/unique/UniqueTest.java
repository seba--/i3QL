...
public class UniqueTest {
	...
	private static final UniqueTermFlattener FLATTENER = new UniqueTermFlattener();
	...
	public static void initialize() {
		...
		Term _ = UniqueTermFlattener.SEPARATOR;
		
		queries = new Term[][] {
			new Term[] { instr }, 				// all instructions
			new Term[] { instr, _, m_2 }, 			// all instructiosn of method 2
			new Term[] { instr, _, m_10000 },	 	// all instructiosn of method 10000
			new Term[] { instr, _, X, i0 }, 		// all first instructions of each method
			new Term[] { instr, _, X, X, invoke } 	// all invoke instructions
		};
	}
	...
	public void testInsertions() {
		...
		UniqueTrieBuilder builder = new UniqueTrieBuilder();
		for (int i = 0; i < TEST_RUNS; i++) {
			...
			// Insert into a trie
			UniqueTrie root = new UniqueTrie();			
			Stopwatch sw = new Stopwatch();

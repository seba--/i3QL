 ...
 */
class TestCyclicTransitiveClosureAsRecursive
{

    def TC(relation: Relation[Edge], start: Edge => String, end: Edge => String): Relation[(String, String)] = {

        /*
        val recursionBaseLeft = new RecursiveBase (relation)
        val recursionBaseRight = new RecursiveBase (relation)
        ...
        val edges =
            WITH_RECURSIVE (
                ...
                new UnionViewAdd (
                    new EquiJoinView (
                        new DuplicateEliminationView (recursionBaseLeft),
                        new DuplicateEliminationView (recursionBaseRight),
                        end,
                        start,
                        (e1: Edge, e2: Edge) => Edge (e1.start, e2.end)
                    ),
                    relation
        ...
        */
        ...
        val recursionBase = new RecursiveDRed (relation)

        val edges =
            new DuplicateEliminationView (
                new UnionViewAdd (
                    WITH_RECURSIVE (
                        recursionBase,
                        new EquiJoinView (
        ...
        new ProjectionSetRetainingView[Edge, (String, String)](edges, e => (e.start, e.end))
    }

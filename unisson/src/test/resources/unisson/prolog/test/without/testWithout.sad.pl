%------
% Prolog based representation of the Vespucci architecture diagram: D:/masterWorkspace/TestProject/testWithout.sad
...
%------
ensemble('testWithout.sad', 'pb.B1', [], (class_with_members('pb','B1') ), []).
ensemble('testWithout.sad', 'pa', [], (( package('pa') without class('pa','ClassA1') ) ), []).
...
%------
not_allowed('testWithout.sad', 1, 'pb.B1', [], 'pa', [], [all]).

%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/outgoing/inner_outgoing.sad
...
%------
ensemble('inner_outgoing.sad', 'Outer', [], (empty), ['InnerA', 'InnerB']).
ensemble('inner_outgoing.sad', 'InnerA', [], (empty), []).
ensemble('inner_outgoing.sad', 'InnerB', [], (empty), []).
ensemble('inner_outgoing.sad', 'InnerAsNeighbor', [], (empty), []).
ensemble('inner_outgoing.sad', 'OutersNeighbor', [], (empty), []).
...
%------
outgoing('inner_outgoing.sad', 1, 'Outer', [], 'OutersNeighbor', [], [all]).
outgoing('inner_outgoing.sad', 2, 'InnerA', [], 'InnerAsNeighbor', [], [all]).

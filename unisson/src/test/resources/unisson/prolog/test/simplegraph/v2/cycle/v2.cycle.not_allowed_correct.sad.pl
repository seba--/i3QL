%------
% Prolog based representation of the Vespucci architecture diagram: v2.cycle.not_allowed_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
ensemble('v2.cycle.not_allowed_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v2.cycle','A')), []).
ensemble('v2.cycle.not_allowed_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v2.cycle','B')), []).

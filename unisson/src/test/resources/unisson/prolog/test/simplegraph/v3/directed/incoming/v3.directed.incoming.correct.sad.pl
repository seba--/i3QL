%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/simplegraph/v3/directed/incoming/v3.directed.incoming.correct.sad
...
%------
ensemble('v3.directed.incoming.correct.sad', 'A', [], (class_with_members('unisson.test.simplegraph.v3.directed.incoming','A') ), []).
ensemble('v3.directed.incoming.correct.sad', 'B', [], (class_with_members('unisson.test.simplegraph.v3.directed.incoming','B') ), []).
ensemble('v3.directed.incoming.correct.sad', 'C', [], (class_with_members('unisson.test.simplegraph.v3.directed.incoming','C') ), []).
...
%------
incoming('v3.directed.incoming.correct.sad', 1, 'A', [], 'C', [], [all]).
incoming('v3.directed.incoming.correct.sad', 2, 'B', [], 'C', [], [all]).

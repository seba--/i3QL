%------
% Prolog based representation of the Vespucci architecture diagram: v3.cycle.expected_violation.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
ensemble('v3.cycle.expected_violation.sad', 'A', [], (class_with_members('opal.test.simplegraph.v3.cycle','A')), []).
ensemble('v3.cycle.expected_violation.sad', 'B', [], (class_with_members('opal.test.simplegraph.v3.cycle','B')), []).
ensemble('v3.cycle.expected_violation.sad', 'C', [], (class_with_members('opal.test.simplegraph.v3.cycle','C')), []).
...
%------
expected('v3.cycle.expected_violation.sad', 1, 'A', [], 'C', [], [all]).
expected('v3.cycle.expected_violation.sad', 2, 'B', [], 'A', [], [all]).
expected('v3.cycle.expected_violation.sad', 3, 'C', [], 'B', [], [all]).

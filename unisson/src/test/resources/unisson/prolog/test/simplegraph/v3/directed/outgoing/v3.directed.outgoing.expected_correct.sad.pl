%------
% Prolog based representation of the Vespucci architecture diagram: v3.directed.outgoing.expected_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
ensemble('v3.directed.outgoing.expected_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v3.directed.incoming','A')), []).
ensemble('v3.directed.outgoing.expected_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v3.directed.incoming','B')), []).
ensemble('v3.directed.outgoing.expected_correct.sad', 'C', [], (class_with_members('opal.test.simplegraph.v3.directed.incoming','C')), []).
...
%------
expected('v3.directed.outgoing.expected_correct.sad', 1, 'A', [], 'B', [], [all]).
expected('v3.directed.outgoing.expected_correct.sad', 2, 'A', [], 'C', [], [all]).

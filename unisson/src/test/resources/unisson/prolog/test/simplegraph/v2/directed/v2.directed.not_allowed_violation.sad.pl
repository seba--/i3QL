%------
% Prolog based representation of the Vespucci architecture diagram: v2.directed.not_allowed_violation.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de

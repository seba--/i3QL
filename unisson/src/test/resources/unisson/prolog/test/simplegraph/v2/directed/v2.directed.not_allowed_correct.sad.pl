%------
% Prolog based representation of the Vespucci architecture diagram: v2.directed.not_allowed_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
not_allowed('v2.directed.not_allowed_correct.sad', 1, 'B', [], 'A', [], [all]).

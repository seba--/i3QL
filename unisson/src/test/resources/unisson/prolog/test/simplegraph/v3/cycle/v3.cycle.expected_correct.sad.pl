%------
% Prolog based representation of the Vespucci architecture diagram: v3.cycle.expected_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
ensemble('v3.cycle.expected_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v3.cycle','A')), []).
ensemble('v3.cycle.expected_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v3.cycle','B')), []).
ensemble('v3.cycle.expected_correct.sad', 'C', [], (class_with_members('opal.test.simplegraph.v3.cycle','C')), []).
...
%------
expected('v3.cycle.expected_correct.sad', 1, 'C', [], 'A', [], [all]).
expected('v3.cycle.expected_correct.sad', 2, 'B', [], 'C', [], [all]).
expected('v3.cycle.expected_correct.sad', 3, 'A', [], 'B', [], [all]).

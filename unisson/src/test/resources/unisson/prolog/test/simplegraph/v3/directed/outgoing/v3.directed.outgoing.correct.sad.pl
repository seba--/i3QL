%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/simplegraph/v3/directed/outgoing/v3.directed.outgoing.correct.sad
...
%------
ensemble('v3.directed.outgoing.correct.sad', 'A', [], (class_with_members('unisson.test.simplegraph.v3.directed.outgoing','A') ), []).
ensemble('v3.directed.outgoing.correct.sad', 'B', [], (class_with_members('unisson.test.simplegraph.v3.directed.outgoing','B') ), []).
ensemble('v3.directed.outgoing.correct.sad', 'C', [], (class_with_members('unisson.test.simplegraph.v3.directed.outgoing','C') ), []).
...
%------
outgoing('v3.directed.outgoing.correct.sad', 1, 'A', [], 'B', [], [all]).
outgoing('v3.directed.outgoing.correct.sad', 2, 'A', [], 'C', [], [all]).

%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/simplegraph/v2/cycle/v2.cycle.expected_correct.sad
...
%------
ensemble('v2.cycle.expected_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v2.cycle','A')), []).
ensemble('v2.cycle.expected_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v2.cycle','B')), []).
...
%------
expected('v2.cycle.expected_correct.sad', 1, 'A', [], 'B', [], [all]).
expected('v2.cycle.expected_correct.sad', 2, 'B', [], 'A', [], [all]).

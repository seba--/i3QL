%------
% Prolog based representation of the Vespucci architecture diagram: v2.cycle.expected_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
expected('v2.cycle.expected_correct.sad', 1, 'B', [], 'A', [], [all]).
expected('v2.cycle.expected_correct.sad', 2, 'A', [], 'B', [], [all]).

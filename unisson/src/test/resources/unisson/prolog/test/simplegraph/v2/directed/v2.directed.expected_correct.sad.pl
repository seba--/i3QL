%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/simplegraph/v2/directed/v2.directed.expected_correct.sad
...
%------
ensemble('v2.directed.expected_correct.sad', 'A', [], (class_with_members('unisson.test.simplegraph.v2.directed','A') ), []).
ensemble('v2.directed.expected_correct.sad', 'B', [], (class_with_members('unisson.test.simplegraph.v2.directed','B') ), []).
...
%------
expected('v2.directed.expected_correct.sad', 1, 'A', [], 'B', [], [all]).

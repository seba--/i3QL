%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/opal/unisson/unisson-test/src/main/prolog/opal/test/simplegraph/v2/directed/v2.directed.expected_correct.sad
...
%------
ensemble('v2.directed.expected_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v2.directed','A')), []).
ensemble('v2.directed.expected_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v2.directed','B')), []).

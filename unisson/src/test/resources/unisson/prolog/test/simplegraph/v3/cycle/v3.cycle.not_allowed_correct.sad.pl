%------
% Prolog based representation of the Vespucci architecture diagram: v3.cycle.not_allowed_correct.sad% Created by Vespucci, Technische Universität Darmstadt, Department of Computer Science
% www.opal-project.de
...
%------
ensemble('v3.cycle.not_allowed_correct.sad', 'A', [], (class_with_members('opal.test.simplegraph.v3.cycle','A')), []).
ensemble('v3.cycle.not_allowed_correct.sad', 'B', [], (class_with_members('opal.test.simplegraph.v3.cycle','B')), []).
ensemble('v3.cycle.not_allowed_correct.sad', 'C', [], (class_with_members('opal.test.simplegraph.v3.cycle','C')), []).
...
%------
not_allowed('v3.cycle.not_allowed_correct.sad', 1, 'B', [], 'A', [], [all]).
not_allowed('v3.cycle.not_allowed_correct.sad', 2, 'C', [], 'B', [], [all]).
not_allowed('v3.cycle.not_allowed_correct.sad', 3, 'A', [], 'C', [], [all]).

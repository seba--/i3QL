%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/transitive/inheritance/allSubtypesIA.sad
...
%------
ensemble('allSubtypesIA.sad', 'AllSubtypesIA', [], (class(transitive(supertype(class('unisson.test.transitive.inheritance','IA'))))), []).

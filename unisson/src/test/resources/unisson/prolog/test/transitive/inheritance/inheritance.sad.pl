%------
% Prolog based representation of the Vespucci architecture diagram: D:/workspace/sae/unisson/src/test/resources/unisson/prolog/test/transitive/inheritance/inheritance.sad
...
%------
ensemble('inheritance.sad', 'AllSubtypesIA', [], (class(transitive(supertype(class('unisson.test.transitive.inheritance','IA'))))), []).
ensemble('inheritance.sad', 'AllSubtypesIB', [], (class(transitive(supertype(class('unisson.test.transitive.inheritance','IB'))))), []).
ensemble('inheritance.sad', 'AllSubTypesC2', [], (class(transitive(supertype(class('unisson.test.transitive.inheritance','C2'))))), []).

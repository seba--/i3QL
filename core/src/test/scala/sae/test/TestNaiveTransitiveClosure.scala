...
class TestNaiveTransitiveClosure extends org.scalatest.junit.JUnitSuite
{
    ...
    def addTest() {
        //test for figure 1 (a)
        val view: Relation[(Vertex, Vertex)] = new NaiveTransitiveClosureView[Edge, Vertex](smallAddTestGraph, (x: Edge) => x.start, (x: Edge) => x.end)
    ...
    def removeTest() {
        //test for figure 2
        val view: Relation[(Vertex, Vertex)] = new NaiveTransitiveClosureView[Edge, Vertex](smallRemoveGraph, (x: Edge) => x.start, (x: Edge) => x.end)
        val res: QueryResult[(Vertex, Vertex)] = view
    ...
    def testSet() {
        ...
        val view: Relation[(Vertex, Vertex)] = new NaiveTransitiveClosureView[Edge, Vertex](testGraph, (x: Edge) => x.start, (x: Edge) => x.end)
        val res: QueryResult[(Vertex, Vertex)] = view
        //add some edges
        testGraph += Edge ("a", "b")
    ...
    def rndTestHelpber() {
        ...
        val tc = new NaiveTransitiveClosureView (source, (_: (java.lang.Integer, java.lang.Integer))._1, (_: (java.lang.Integer, java.lang.Integer))._2)

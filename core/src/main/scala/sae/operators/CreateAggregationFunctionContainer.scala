...
object CreateAggregationFunctionContainer {
  ...
  def applySelf[Domain <: AnyRef, Value1 <: Any, Value2 <: Any,Af1 <: AggregateFunction[Domain,Value1],Af2 <: AggregateFunction[Domain,Value2]](f1 : AggregateFunctionFactory[Domain, Value1, Af1], f2 : AggregateFunctionFactory[Domain, Value2,Af2 ]) : SelfMaintainalbeAggregateFunctionFactory[Domain, (Value1, Value2)] = {
  ...
  def applySelf[Domain <: AnyRef, Value1 <: Any, Value2 <: Any, Value3 <: Any,Af1 <: AggregateFunction[Domain,Value1],Af2 <: AggregateFunction[Domain,Value2],Af3 <: AggregateFunction[Domain,Value3]](f1 : AggregateFunctionFactory[Domain, Value1, Af1], f2 : AggregateFunctionFactory[Domain, Value2, Af2], f3 : AggregateFunctionFactory[Domain, Value3, Af3]) : SelfMaintainalbeAggregateFunctionFactory[Domain, (Value1, Value2, Value3)] = {
  ...
  def applyNotSelf[Domain <: AnyRef, Value1 <: Any, Value2 <: Any,Af1 <: AggregateFunction[Domain,Value1],Af2 <: AggregateFunction[Domain,Value2]](f1 : AggregateFunctionFactory[Domain, Value1, Af1], f2 : AggregateFunctionFactory[Domain, Value2,Af2]) : NotSelfMaintainalbeAggregateFunctionFactory[Domain, (Value1, Value2)] = {      new NotSelfMaintainalbeAggregateFunctionFactory[Domain, (Value1, Value2)] {
  ...
  def applyNotSelf[Domain <: AnyRef, Value1 <: Any, Value2 <: Any, Value3 <: Any,Af1 <: AggregateFunction[Domain,Value1],Af2 <: AggregateFunction[Domain,Value2],Af3 <: AggregateFunction[Domain,Value3]](f1 : AggregateFunctionFactory[Domain, Value1,Af1], f2 : AggregateFunctionFactory[Domain, Value2,Af2], f3 : AggregateFunctionFactory[Domain, Value3,Af3]) : NotSelfMaintainalbeAggregateFunctionFactory[Domain, (Value1, Value2, Value3)] = {

...
f <- file.path(dir, "hospital1-fjd-measure_20000-2","benchmark-cpu.csv") 
from <- 0
to <- 360
...
par(cex=1.6)
plot(clientData$date, clientData$cpu, type="n", yaxt="n", xlim=c(0,2000), ylim=c(0.0,1.0), xlab = "Time elapsed (ms)", ylab = "CPU load")

...
f <- file.path("hospital", "2016-11-09", "query3", "default-25000_measure-50000_4", "benchmark-cpu.csv")
from <- 0
to <- 750
...
par(cex=1.6)
plot(clientData$date, clientData$cpu, type="n", yaxt="n", xlim=c(0,2000), ylim=c(0.0,1.1), xlab = "Time elapsed (ms)", ylab = "CPU load")
